...
public class MyInfoFavActivity extends Activity implements IWeiboActivity,
		OnClickListener {
	private static final String TAG = "MyInfoFavActivity";
	...
	public void init() {
		// TODO Auto-generated method stub
		mBackBtn = (Button) this.findViewById(R.id.btn_myinfo_fav_title_back);
		mHomeBtn = (Button) this.findViewById(R.id.btn_myinfo_fav_title_home);
	...
	public void refresh(Object... params) {
		// TODO Auto-generated method stub
		mFavorites = (ArrayList<Favorite>) params[0];
		ArrayList<Status> mStatus = new ArrayList<Status>();
		for (int i = 0; i < mFavorites.size(); i++) {
			Favorite favorite = mFavorites.get(i);
			mStatus.add(favorite.getmStatus());
		}
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.btn_myinfo_fav_title_back:
			this.finish();
			break;
		case R.id.btn_myinfo_fav_title_home:
			this.finish();
			break;
	...
	private void createTask(int mCurrentState, long max_id) {
		...
		mTask = new Task(Task.WEIBO_MYINFO_FAVORITES, mTaskParams);
